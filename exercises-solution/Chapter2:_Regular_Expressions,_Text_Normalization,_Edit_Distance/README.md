### 2.1 Write regular expressions for the following languages. ([solutions](exercise-solution/Chapter2:_Regular_Expressions,_Text_Normalization,_Edit_Distance/exercise2.1.ipynb))
